...
/**
 * FotoRapor Kurumsal PDF Tasarım Sistemi - Tipografi ve Boya (Paint) Yöneticisi
 * Baskı kalitesi ve mühendislik doküman standartlarına uygun font kalınlıkları ve hiyerarşisi sağlar.
 */
class PdfTypography {
    ...
    // Dekoratif Çizgi ve Çevreleme Boyaları
